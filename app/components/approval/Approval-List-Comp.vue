        ...
        <StackLayout orientation="horizontal" class="borderContents">
            <StackLayout @tap="onHeaderTap" :id="item.submit_id" orientation="horizontal" class="contents" >
                <GridLayout columns="auto, *" rows="auto, auto, auto, auto, auto, auto, auto" marginLeft="10" class="eachGrid">
                    <Label row="0" col="0" :text="item.submit_name + ' / '+ item.office_code_name" class="title"></Label>
                    <Label row="0" col="1" text.decode="&#xf103;" horizontalAlignment="right" class="fa icon"></Label>

                    <Label row="1" col="0" class="detailTitle" text="신청일자" :visibility="detailDataVisability"></Label>
                    <Label row="1" col="1" class="detailContent" :text="requestDateCnvt" horizontalAlignment="right" :visibility="detailDataVisability"></Label>

                    <Label row="2" col="0" class="detailTitle" text="처리일자" :visibility="detailDataVisability"></Label>
                    <Label row="2" col="1" class="detailContent" :text="decideDateCnvt" horizontalAlignment="right" :visibility="detailDataVisability"></Label>

                    <Label row="3" col="0" class="detailTitle" text="신청기간" :visibility="detailDataVisability"></Label>
                    <Label row="3" col="1" class="detailContent" :text="periodCnvt" horizontalAlignment="right" :visibility="detailDataVisability"></Label>

                    <Label row="4" col="0" class="detailTitle" text="신청일수" :visibility="detailDataVisability"></Label>
                    <Label row="4" col="1" class="detailContent" v-show="item.day_count > 0" :text="item.day_count + '일'" horizontalAlignment="right" :visibility="detailDataVisability"></Label>

                    <Label row="5" col="0" class="detailTitle" text="외근시간" :visibility="detailDataVisability"></Label>
                    <Label row="5" col="1" class="detailContent" :text="outOffiecCnvt" horizontalAlignment="right" :visibility="detailDataVisability"></Label>
